...
export default function AdminPage() {
  ...
  return (
    <section className="w-full grid grid-cols-1 lg:grid-cols-[260px_1fr] gap-0 h-[calc(100vh-120px)]">
      ...
      <aside
        className={`
          fixed inset-y-0 left-0 z-40 w-[260px] bg-slate-950/95 backdrop-blur-xl border-r border-slate-800/80
      ...
      >
        <div className="flex flex-col h-full overflow-y-auto px-4 py-6 scrollbar-thin">
          ...
          <div className="flex items-center gap-3 px-3 mb-6">
            ...
            <div>
              <h3 className="text-sm font-bold text-slate-100 tracking-tight">Admin Panel</h3>
              <p className="text-[11px] text-slate-500">AI Chatbot Manager</p>
            </div>
          </div>
                ...
                {group.items.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {item.shortcut && (
                        <kbd className="ml-auto text-[10px] text-slate-600 bg-slate-800/80 px-1.5 py-0.5 rounded font-mono">
                          Alt+{item.shortcut}
                        </kbd>
                      )}
                    </button>
          ...
          {/* Footer */}
          <div className="mt-6 px-3 pt-4 border-t border-slate-800/60">
            <p className="text-[10px] text-slate-600 text-center">
              Press Alt+1…0 for quick nav
            </p>
          </div>
        </div>
      </aside>
