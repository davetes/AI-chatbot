...
class Settings:
    ...
    def reload(self) -> None:
        ...
        self.bot_system_prompt = os.getenv("BOT_SYSTEM_PROMPT", "")
        self.bot_persona = os.getenv("BOT_PERSONA", "default")
        self.bot_tone = os.getenv("BOT_TONE", "friendly")
        self.admin_api_key = os.getenv("ADMIN_API_KEY", "")
        self.default_tenant_id = os.getenv("DEFAULT_TENANT_ID", "default")
        self.kb_path = os.getenv("KB_PATH", os.path.join(os.getcwd(), "data", "knowledge_base"))
        self.workflow_rules_path = os.getenv(
            "WORKFLOW_RULES_PATH", os.path.join(os.getcwd(), "data", "workflows.json")
        )
